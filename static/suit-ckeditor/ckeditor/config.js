...
CKEDITOR.editorConfig = function(config) {
    ...
    config.plugins = "basicstyles,contextmenu,dialog,dialogadvtab,elementspath," +
        ...
        "list,link,removeformat,sourcearea,specialchar,stylescombo,tab,toolbar,undo,wysiwygarea";
...
CKEDITOR.stylesSet.add('default', [
    ...
    {name: 'Advantages title', element: ['p', 'h2'], attributes: {'class': 'advantages-title'}},
    {name: 'Two columns', element: ['div', 'ol', 'ul'], attributes: {'class': 'two-columns'}},
    {name: 'Five columns', element: ['div', 'ol', 'ul'], attributes: {'class': 'five-columns'}}
]);
