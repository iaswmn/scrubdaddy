...
class SocialLinks(SingletonModel):
    social_linkedin = models.URLField(_('linkedin'), max_length=255, blank=True)
    ...
    social_pinterest = models.URLField(_('pinterest'), max_length=255, blank=True)
    social_youtube = models.URLField(_('youtube'), max_length=255, blank=True)
    social_google_plus = models.URLField(_('google plus'), max_length=255, blank=True)
    social_yelp = models.URLField(_('yelp'), max_length=255, blank=True)
    updated = models.DateTimeField(_('change date'), auto_now=True)
